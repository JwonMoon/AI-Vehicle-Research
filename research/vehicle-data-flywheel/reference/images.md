...
| 그림 5 | `images/fig2-general-ai-flywheel.svg` | 일반 AI(LLM 에이전트) 데이터 플라이휠 7단계 | 자체 작성 | NVIDIA-AI-Blueprints/data-flywheel README 🔍 (2.1절) |
| 그림 6 | `images/src-nvidia-data-flywheel-blueprint.png` | NVIDIA 데이터 플라이휠 블루프린트 구조도 | [NVIDIA-AI-Blueprints/data-flywheel](https://github.com/NVIDIA-AI-Blueprints/data-flywheel) `docs/images/data-flywheel-blueprint.png` · Apache-2.0 | 원본 4008×2475 → 폭 1800으로 축소 |
