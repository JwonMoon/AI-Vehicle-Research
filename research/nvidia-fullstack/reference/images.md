...
| 파일 | 설명 | 사용 문서 |
|---|---|---|
| `3-0-av-stack-map-v2.svg` | NVIDIA 자율주행 스택 계층·3-computer 위치·성숙도 요약 지도 (현행판: 블록 안 챕터 표기 제거, 텍스트가 블록 안에 들어오도록 열 폭·줄바꿈 조정, 증류 경로를 블록 사이로 배선, 열 제목의 원 번호·상단 범례 제거, 파랑은 Alpamayo·DRIVE AV 블록만) | 3장 3.0.3 · report-03 그림 1 |
