...
| **설명형 보고서 (HTML)** | [report.html](report.html) — 처음 읽는 사람을 위해 3장·7장·부록 A를 "질문 → 쉬운 설명 → 비유 → 사실 정리 → 근거"로 다시 쓴 보고서. 사실·수치·출처는 md 원본과 동일하게 전부 포함(3분 요약, 핵심 용어 10개, 사이드바 목차 포함). md 3종은 사실 목록 형식의 조사 원본 | 본 폴더 작성자 | ✅ |
